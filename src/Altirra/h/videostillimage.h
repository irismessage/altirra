...
#ifndef f_AT_VIDEOSTILLIMAGE_H
#define f_AT_VIDEOSTILLIMAGE_H
...
private:
	...
	float mImageXScale = 0;
	float mImageXOffset = 0;
	float mImageYScale = 0;
	float mImageYOffset = 0;
	bool mbInited = false;
	bool mbImageLoadFailed = false;
};
